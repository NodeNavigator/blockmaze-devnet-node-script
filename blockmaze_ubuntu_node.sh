...
BINARY_URL="https://github.com/NodeNavigator/blockmaze-devnet-node-script/releases/download/ubuntu${VERSION}-goleveldb/${BINARY}"
echo $BINARY_URL
...
echo "The file $file_path exists."
  ...
  # Change proposal periods to pass within a reasonable time for local testing
    ...
    sed -i 's/minimum-gas-prices = "0bmz"/minimum-gas-prices = "0.25bmz"/g' "$APP_TOML"
